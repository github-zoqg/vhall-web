...
const vueURL = ['production', 'pre'].includes(process.env.VUE_APP_NODE_ENV) ? '//s1.e.vhall.com/common-static/middle/vue/2.6.11/vue.min.js' : '//t-alistatic01.e.vhall.com/common-static/middle/vue/2.6.11/vue.js'
