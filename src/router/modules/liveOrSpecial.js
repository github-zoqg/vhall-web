    ...
    children: [
      {
        ...
        meta: { auth: true, title: '专题列表', name: 'specialList', level: 2, activeMenu: '/subject/list', auth_key: 'subject_manager' }
      },
      {
        path: 'edit',
        component: () => import('@/views/SpecialModule/edit'),
        meta: { auth: true, title: '创建专题', name: 'subjectEdit', level: 2, activeMenu: '/subject/edit', auth_key: 'subject_manager' }
      },
      {
        path: 'edit/:id',
        component: () => import('@/views/SpecialModule/edit'),
        meta: { auth: true, title: '编辑专题', name: 'subjectEdit', level: 2, activeMenu: '/subject/list', auth_key: 'subject_manager' },
        hidden: true
      },
      {
        path: 'data/:id',
        component: () => import('@/views/SpecialModule/data'),
        meta: { auth: true, title: '查看数据', name: 'subjectData', level: 2, activeMenu: '/subject/list', auth_key: 'subject_manager'},
        hidden: true
      },
      {
        path: 'viewer/:id',
        component: () => import('@/views/SpecialModule/viewer'),
        meta: { auth: true, title: '观看限制', name: 'subjectViewer', level: 2, activeMenu: '/subject/list', auth_key: 'subject_manager'},
        hidden: true
      },
      {
        path: 'details/:id',
        component: () => import('@/views/SpecialModule/details'),
        meta: { auth: true, title: '专题详情', name: 'subjectDetails', level: 2, activeMenu: '/subject/list', auth_key: 'subject_manager' },
        hidden: true
      }
    ]
  },
