...
const router = [
    ...
    children: [
      ...
      },
      {
        ...
        meta: {
          ...
          name: 'vodCreate',
          webinarType: 'vod',
          activeMenu: '/live/vodEdit',
          auth_key: 'ui.upload_video_as_demand'
        }
      },
      {
        path: 'timeEdit',
        ...
        meta: {
          ...
          name: 'liveTimeCreate',
          webinarType: 'time',
          activeMenu: '/live/timeEdit',
          auth_key: 'webinar.timing'
        }
      },
      {
        path: 'timeEdit/:id',
  ...
  },
  {
    ...
    meta: {
      ...
      title: '专题管理',
      name: 'specialList',
      icon: 'saasicon_projects_img',
      level: 1,
      auth_key: 'subject_manager'
    },
    children: [
      {
        path: 'list',
