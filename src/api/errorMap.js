const errorMap = {
  ...
  12511: '当前已有主持人进入直播间',
  12512: '相同角色超过同时在线上限',
  12513: '检测到您已登录主办方账号，请先退出账号或使用其他浏览器访问',
  12514: '您已被禁止访问房间！',
  12515: '未找到参会数据',
  12516: '该账号已进入直播',
  12517: '没有互动直播权限',
  ...
  12520: '转播不能与转播源相同',
  12521: '直播未开始',
  12522: '主持人、嘉宾或助理直播时不能进入观看端',
  12523: '需要付费',
  12524: '被转播活动未开始直播',
  12525: '需要填写报名表单',
  12526: '检测类型和活动观看限制类型不一致',
  12527: '密码错误',
  12528: '请输入密码',
  12529: '邀请码错误',
  12530: '邀请码已被使用',
  12531: '请输入邀请码',
  12532: '请输入白名单手机号|邮箱|工号|其它',
  12534: '跳转链接',
  12535: '组织者对该活动设置了验证机制',
  12536: '回放不存在',
  12537: '热度不能小于在线人数',
  12538: '组织者对该活动设置了验证机制,验证失败',
  12539: 'sdk验证只支持key值验证',
  12540: '活动已结束',
  12541: '活动现场太火爆，已超过人数上限',
  12542: '访客数据信息不全',
  12543: '此视频暂时下线了',
  12544: '该视频已下线，有疑问请联系客服',
  12545: '该视频转码失败',
  12546: '该视频正在转码中',
  12547: '亲，嵌入页面只支持三种验证方式：默认、密码、第三方K值！无法观看，请联系活动主办方',
  12548: '正在录制中，无法发起直播',
  12549: '非直播中活动',
  12550: '正在直播中，无法发起录制',
  12551: '仅支持音视频',
  12552: '分辨率错误，目前只支持 a,360p,480p,720p,same',
  12553: '回调地址格式错误',
  12554: '上传的点播不允许操作',
  12555: '当前分辨率已经转换，请误重复操作!',
  12556: '当前分辨率正在转换，请误重复操作!',
  12557: '当前分辨率系统转换失败!',
  12558: '当前分辨率的下载任务已请求，请误重复操作!',
  12559: '当前下载的分辨率回放未生成，请先生成后下载!',
  12560: '该视频正在审核中',
  12561: '流信息不存在',
  12562: '无极版流量已达上限',
  12563: '并发已达上限',
  12564: '无极版并发已达上限',
  12565: '活动所有者不是会员，暂不能进入',
  12566: '你有修改的章节正在保存中',
  12567: '不支持的活动类型(必须是点播)',
  12568: '未传入回调地址且回调地址未配置',
  12569: '无权操作主持人邮箱',
  12570: '短信验证码错误',
  12600: '开始或结束活动异常',
  12601: '开始或关闭转播流异常',
  ...
  11020: '子账号没有权限操作',
  11021: '不是子账号',
  11022: '该手机号已被其他账号绑定，请使用其他手机号',
  11023: '该邮箱已被其他账号绑定，请使用其他邮箱',
  11024: '请勿短时间内重复请求',
  11025: '上传头像异常',
