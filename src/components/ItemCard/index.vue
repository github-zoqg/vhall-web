<template>
  <div>
    <section>
      ...
      <div class="subjectOuter">
        <template v-for="item in readyList">
          <div
            class="sunjectInner"
            @click="blockHandler(item)"
            :key="item.id"
            v-if="item.isShow"
          >
            <span
              ><img
                :src="require(`../../common/images/icon/${item.icon}.png`)"
                alt=""
            /></span>
            <div class="desc">
    ...
    <section
      v-if="
        !(childPremission && Number(childPremission.permission_content) === 0)
      "
    >
      <p class="subject">
      ...
      <div class="subjectOuter">
        ...
        >
          <span>
            <img
              src="../../common/images/icon/icon_timing@2x.png"
              alt=""
              v-if="webinarType == 5"
            />
    ...
    resetList(perssionInfo) {
      ;(this.readyList = [
        ...
        },
        {
          ...
          isShow:
            this.webinarType == 6 ? false : perssionInfo.virtual_user == 1,
        },
        {
        ...
        (this.brandList = [
          ...
          },
          {
            ...
            isShow:
              this.webinarType == 6
                ? false
                : perssionInfo.live_broadcast_window == 1,
          },
          {
        ...
        (this.liveDataList = [
          ...
          },
          {
            ...
            isShow:
              this.webinarType != 5 &&
              perssionInfo['waiting.video.file'] == 1 &&
              this.type != 4,
          },
          {
