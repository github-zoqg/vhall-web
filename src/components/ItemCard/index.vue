  ...
  data() {
    return {
      ...
      liveDataList: [
        ...
        { icon: 'icon_Lucky draw@2x', id: 2, title: '抽奖', subText: '直播中发起抽奖活跃气氛', path: `/live/prizeSet/${this.$route.params.str}`, isShow: this.perssionInfo['ui.hide_lottery']==0},
        { icon: 'icon_questionnaire@2x', id: 3,title: '问卷', subText: '创建问卷收集信息', path: '/live/question',isShow: this.perssionInfo['ui.hide_survey']==0 },
