    ...
    <section v-if="!(childPremission && Number(childPremission.permission_content) === 0)">
      ...
      <div class="subjectOuter">
        <div class="sunjectInner" @click="goHandler(type == 4 ? `/live/recordplayback/${$route.params.str}` : `/live/playback/${$route.params.str}`)">
          ...
          <span><img src="../../common/images/icon/icon_playback@2x.png" alt=""></span>
  ...
  data() {
    return {
      ...
      readyList: [
        ...
        { icon: 'icon_Functional@2x', id: 2, title: '功能配置', subText: `编辑${this.type == 4 ? '点播' :'直播'}功能配置`, path: `/live/planFunction/${this.$route.params.str}`,isShow: true},
        ...
        { icon: 'icon_embedded@2x', id: 8, title: '推广嵌入', subText: `编辑设置${this.type == 4 ? '点播' :'直播'}推广嵌入`, path: `/live/embedCard/${this.$route.params.str}`, isShow: true}
      ],
      brandList: [
        ...
        { icon: 'icon_public@2x', id: 6, title: '公众号展示', subText: '设置观看页展示公众号', path: `/live/officialCard/${this.$route.params.str}`,isShow: this.perssionInfo.live_broadcast_window==1},
      ...
      liveDataList: [
        { icon: 'icon_document@2x', id: 1, title: '文档', subText: '直播中使用文档演示', path: `/live/word/${this.$route.params.str}`,isShow: true},
        { icon: 'icon_Lucky draw@2x', id: 2, title: '抽奖', subText: '直播中发起抽奖活跃气氛', path: `/live/prizeSet/${this.$route.params.str}`, isShow: this.perssionInfo['ui.show_lottery']==1},
        { icon: 'icon_questionnaire@2x', id: 3,title: '问卷', subText: '创建问卷收集信息', path: '/live/question',isShow: this.perssionInfo.survey==1 },
        { icon: 'icon_goods@2x', id: 4, title: '商品', subText: '直播中展示商品给观众', path: `/live/productSet/${this.$route.params.str}`,isShow: this.perssionInfo.product_show==1},
        { icon: 'icon_gift@2x', id: 5, title: '礼物', subText: '直播中观众发送的礼物', path: `/live/gift/${this.$route.params.str}`,isShow: this.perssionInfo['ui.show_gift']==1},
      ],
      reportDataList: [
