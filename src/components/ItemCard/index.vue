  ...
  data() {
    return {
      ...
      liveDataList: [
        ...
        { icon: 'icon_videoSet@2x', id: 1, title: '插播文件', subText: '直播中使用音视频文件演示', type: '000000', path: `/live/videoSet/${this.$route.params.str}`, isShow: this.perssionInfo['waiting.video.file']==1}, 
