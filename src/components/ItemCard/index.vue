  ...
  data() {
    return {
      ...
      liveDataList: [
        ...
        { icon: 'icon_videoSet@2x', id: 6, title: '插播文件', subText: '直播中使用音视频文件演示', type: '000000', path: `/live/videoSet/${this.$route.params.str}`, isShow:  this.webinarType != 5 && this.perssionInfo['waiting.video.file']==1 && this.type != 4},
