<template>
  <div class="transcript-page">
    ...
    <div class="transcript-page--info">
      ...
      <div class="transcript-ctx">
        <div class="transcript-ctx--left">
          <p><label>参会ID:</label><span>{{transcriptInfo.join_id || '--'}}</span></p>
          <p><label>姓名:</label><span>{{transcriptInfo.user_name || '--'}}</span></p>
          <p><label>手机号:</label><span>{{transcriptInfo.mobile || '--'}}</span></p>
          <p><label>答题用时:</label><span>{{transcriptInfo.use_time || '--'}} <!-- 需要转换数据 --></span></p>
          <p><label>正确率:</label><span>{{transcriptInfo.right_rate || '--'}}%</span></p>
    ...
    <div class="transcript-page--answer">
      <div class="transcript-item">
        <span class="transcript-item--title">答题情况：答对{{transcriptInfo.right_num || '--'}}，答错{{transcriptInfo.error_num || '--'}}，未答{{transcriptInfo.unanswer_num || '--'}}</span>
      </div>
...
export default {
  ...
  methods: {
    // 导出数据
    handleDownload() {
      this.$fetch('exportTranscript', this.$params({
