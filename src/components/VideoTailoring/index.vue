    ...
    >
      <div class="vh-video-tailoring__select">
        ...
        <el-date-picker
          ...
          :editable="false"
        ></el-date-picker>
        <el-button class="vh-find-btn" type="primary" slot="append" @click="findVideo" v-if="value == '2'">{{ t('查找') }}</el-button>
        <el-button class="vh-find-btn" v-if="value == '1'" @click="createVideo" type="primary">{{ t('生成') }}</el-button>
      </div>
          ...
          <li v-for="(item,index) in tableData" :key="'tailoring'+index">
            <div class="vh-video-tailoring__data-img">
              ...
              <div class="vh-video-tailoring__webinar-info">
                <p class="vh-video-tailoring__webinar-info-id">
                  ID:{{item.id}}
                </p>
                <p class="vh-video-tailoring__duration">
                  <span class="vh-iconfont vh-icon-shichangicon"></span>{{item.duration}}
                </p>
              </div>
            </div>
