  ...
  <div class="search-area">
    <el-form :inline="true" :model="searchParams" ref="searchForm">
      <el-form-item v-for="(item, index) in searchAreaLayout" :key="index">
        ...
        <!-- 输入框 -->
        <el-input v-model="searchParams[item.key]" suffix-icon="el-icon-search" :placeholder="placeholder" style="width: 180px" v-else @change="changeDate" clearable></el-input>
