<template>
  <div class="vh-editor-wrapbox" :style="{ height: height }">
    ...
    <div class="word-count">
      <span
        :class="
          value && currentCount > 0 && currentCount < (maxWord || 1000)
            ? 'blue'
            : value && currentCount == (maxWord || 1000)
            ? 'red'
            : ''
        "
      >
  ...
  export default {
    ...
    props: {
      ...
      toolbar: {
        ...
        required: false,
        default:
          'fontsizeselect bold italic underline anchor | alignleft aligncenter alignright alignjustify | image | fullscreen'
      },
      height: {
        type: [Number, String],
        required: false,
    ...
    data() {
      return {
        ...
        setting: {
          ...
          content_style:
            'div{font-size: 14px;} p{color:#1a1a1a; margin: 0px; border:0px ; font-size: 14px; padding: 0px; word-break: break-all;}', // 关闭默认p标签间距
