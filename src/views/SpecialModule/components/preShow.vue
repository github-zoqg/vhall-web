      ...
      <el-card>
        <div class="special-main">
          ...
          <div class="special-detail">
            ...
            <h2>共<b>{{ specialInfo.webinar_num }}</b>个直播<span><b>{{ specialInfo.num }}</b>次观看</span><b>{{ specialInfo.order_num }}</b>次预约</h2>
            <div class="shareText">
              <el-popover
                ...
                <div class="inner">
                  ...
                  <div class="bottom">
                    <div class="">
                      ...
                      <p class="liveTime">{{item.start_time}} <span><i class="iconfont-v3 saasicon_redu"></i> {{item.num}}</span></p>
                    </div>
                  </div>
                </div>
              </el-col>
