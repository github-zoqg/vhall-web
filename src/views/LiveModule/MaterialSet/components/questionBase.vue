  ...
  <div class="height-question">
    <div class="show-question question-base" v-if="dataBaseVisible">
      <div class="show-main data-base">
        <p class="title">
          选择问卷
          <i class="el-icon-close" @click="dataBaseVisible = false"></i>
        </p>
        ...
        <div class="data-base-list" v-show="total || isSearch">
          ...
          >
            ...
            <el-table-column fixed prop="updated_at" label="更新时间"></el-table-column>
            <el-table-column fixed prop="topic_num" label="题目数量"></el-table-column>
            <el-table-column width="100" fixed label="操作">
              <template slot-scope="scope">
        ...
        <div class="no-live" v-show="!total && !(isSearch && total == 0)">
          <noData :nullType="'nullData'" :text="'您还没有问卷，快来创建吧！'" :height="10">
            <el-button type="primary" round @click="addQuestion" v-preventReClick>
              创建问卷
            </el-button>
          </noData>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      choseSureQuestion() {
        ...
        this.$fetch('sharedLiveQuestion', params)
          .then(res => {
