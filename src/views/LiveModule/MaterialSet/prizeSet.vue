<template>
  <div class="prize-card">
    <pageTitle pageTitle="抽奖"></pageTitle>
          ...
          <div class="give-item">
            <div class="give-prize">
              <el-form :model="formData" ref="ruleForm" label-width="80px">
                ...
                <el-form-item>
                  <el-button type="primary" round @click="lotterySave" v-preventReClick>
                    保存
                  </el-button>
                </el-form-item>
              </el-form>
            ...
            <div class="give-show">
              <div class="give-people">
                <div class="prize-mask">
                  <div class="prize-show" :style="`backgroundImage: url(${backgroundImg})`"></div>
                </div>
          ...
          <div class="give-item">
            <div class="give-prize give-live">
              <el-form :model="givePrizeForm" ref="ruleForm" label-width="100px">
                ...
                <el-form-item>
                  <el-button type="primary" round @click="sureGivePrize" v-preventReClick>
                    保存
                  </el-button>
                </el-form-item>
              </el-form>
                ...
                <div class="prize-mask">
                  <div class="accept-review">
                    <div class="padding-container">
                      ...
                      <div class="sureBtn">
                        <el-button type="primary" v-preventReClick round>确定</el-button>
                      </div>
                    </div>
                    <!-- </el-scrollbar> -->
                  </div>
...
<script>
  ...
  export default {
    ...
    computed: {
      isDisabled: function () {
        if (
          this.formData.description != this.localLottery.description ||
          this.isChecked != this.localImg ||
          this.formData.title != this.localLottery.title ||
          this.previewSrc != this.localLottery.img_path
        ) {
          return false;
        } else {
          return true;
        ...
        try {
          this.givePrizeList.forEach((ele, index) => {
            if (
              ...
              ele.is_required != Boolean(this.lotteryPageMessage[index].is_required)
            ) {
              throw '改变';
            }
          });
    ...
    methods: {
      ...
      sureGivePrize() {
        ...
        this.$fetch('saveDrawPrizeInfo', {
          webinar_id: this.$route.params.str,
          data: JSON.stringify(this.givePrizeList)
        })
          .then(res => {
            if (res.code == 200) {
              this.$message({
