    ...
    <div class="word-list">
      ...
      >
        <!-- <el-table-column
          ...
          align="left"
        /> -->
        <el-table-column type="selection" width="52" align="left" />
        ...
        <el-table-column label="页码" prop="page" width="84px"></el-table-column>
        <el-table-column label="进度" width="164px">
          <template slot-scope="scope">
      ...
      <div class="btn-center">
        <span class="select-option">
          当前选中
          <strong>{{ dialogMulti.length }}</strong>
          个文档
        </span>
        <el-button
          v-preventReClick
  ...
  export default {
    ...
    methods: {
      ...
      getDialogTableList() {
        ...
        this.$fetch('getWordList', this.$params(params))
          .then(res => {
            if (res && res.code === 200) {
      ...
      saveCheckHandle() {
        ...
        if (this.dialogMulti && this.dialogMulti.length > 0) {
          if (this.tableDataLength) {
            this.$confirm(
              '当前视频内容已有关联文档，再次关联文档，将会清除已设置的全部章节内容，确认继续？',
              '提示',
              {
