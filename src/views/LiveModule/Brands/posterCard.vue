  ...
  <div class="offical-show">
    <pageTitle pageTitle="开屏海报">
      <div class="switch__box">
        <el-switch class="el-role-switch" v-model="status" :active-value="0" :inactive-value="1" active-color="#ff4949"
          inactive-color="#ccc" @change="changeOpenStatus" :active-text="activeTitle">
        </el-switch>
      </div>
    </pageTitle>
        ...
        <div class="official-form">
          <el-form label-width="120px" :model="form" ref="officialForm" :rules="formRules">
            ...
            <el-form-item label="链接" prop="url">
              <VhallInput v-model.trim="form.url" v-clearEmoij placeholder="请输入http://或https://开头的链接" :maxlength="200"
                autocomplete="off"></VhallInput>
            </el-form-item>
            <el-form-item label="自动关闭">
              <!--{{alertType 0手动关闭 1自动关闭}}-->
              <div class="switch__box">
                <el-switch v-model="alertType" :active-value="1" :inactive-value="0" active-color="#ff4949"
                  inactive-color="#ccc" :active-text="autoUpText">
                </el-switch>
              </div>
            </el-form-item>
            <el-form-item>
    ...
    .hb_pc {
      .poster-btn {
        ...
        /* right: 6px;
          ...
          width: 28px;
          height: 12px; */
        background: url('../../../common/images/poster/pc_poster_close@2x.png')
          no-repeat;
        background-size: 100% 100%;
        &.five {
          background: url('../../../common/images/poster/pc_poster_close5@2x.png')
            no-repeat;
          background-size: 100% 100%;
        }
      }
