  ...
  <div class="single-question">
    ...
    <div class="question-title">
      ...
      <p>
        ...
        <span>{{ total }}人</span>
        <b>|</b>
        <span class="export" @click="exportSingleQuerstion">导出数据</span>
      </p>
  ...
  export default {
    ...
    methods: {
      getQuerstionList() {
        ...
        this.$fetch('getQuestionDetailList', this.$params(params))
          .then(res => {
