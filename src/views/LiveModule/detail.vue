    ...
    return {
      ...
      operas: {
        "准备": [
          ...
          { icon: '', title: '虚拟人数', subText: '添加直播的虚拟人数', path: '/setting-chat' },
          { icon: '', title: '报名表单', subText: '开启后收集目标观众信息', path: '/signup'},
          { icon: '', title: '推广嵌入', subText: '编辑设置直播推广嵌入', path: '/setting-chat' },
        ],
        "品牌": [
          ...
          { icon: '', title: '公众号展示', subText: '设置观看页展示公众号' },
          { icon: '', title: '开屏海报', subText: '设置观看页的开屏海报' },
        ],
        "直播": [
        ...
        "回放": [
          { icon: '', title: '回放管理', subText: '管理直播回放内容' },
