          ...
          <div class="info">
            ...
            <div class="action-look">
              <el-button
                ...
                size="small"
                v-if="
                  [3, 5].includes(liveDetailInfo.webinar_state) && liveDetailInfo.webinar_type != 5
                "
              ...
              <el-popover placement="bottom" trigger="hover" style="margin-right: 8px">
                <div class="invitation-code">
                  <p>活动观看页</p>
                  <img :src="h5WapLink" alt="" v-if="h5WapLink" />
                  <p>
                    <el-button round type="primary" size="medium" @click="downErCode">
                      下载二维码
                    </el-button>
                  </p>
                </div>
              ...
              <div class="check-url" @mouseout="handlerMouseOut" @mouseover="handleMouseIn">
                ...
                >
                  <p>
                    观看页
                    <el-input id="copy-val" v-model="link" style="width: 320px"></el-input>
                  </p>
                  <div class="copy-item">
                    <el-button
                      round
              ...
              >
                <el-button round size="small" class="check-btn" @click="toDirector(false)">
                  云导播
                </el-button>
                <div
    ...
    methods: {
      ...
      setLowerGradeConfig(data) {
        ...
        this.hasDelayPermission =
          this.perssionInfo['no.delay.webinar'] && this.perssionInfo['no.delay.webinar'] == 1
            ? true
            : false;
      },
      handleChildOver() {
        ...
        if (item.path) {
          if (item.path === '/live/edit') {
            ...
            this.$router.push({
              path: item.path,
              query:
                item.path == `/live/signup/${this.$route.params.str}`
