    ...
    methods: {
      ...
      handleAuth(params) {
        ...
        this.$fetch('callbackUserInfo', {
          ...
          setTimeout(() => {
            window.location.href = `${process.env.VUE_APP_WAP_WATCH}/special/detail?id=${_that.$route.params.str}${delay ? '&delay=' + delay : ''}`
