  ...
  <div class="video-wrap">
    ...
    <div class="video-list" v-if="total || isSearch">
      ...
      >
        ...
        <el-table-column width="160" prop="created_at" label="上传时间"></el-table-column>
        <el-table-column width="100" prop="duration" label="时长"></el-table-column>
        ...
        <el-table-column width="110" prop="storage" label="转码后大小"></el-table-column>
