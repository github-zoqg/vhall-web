  ...
  <div class="download">
    ...
    <div class="list--search">
      <el-button
        ...
        plain
        round
        @click.prevent.stop="multiDownload"
        v-preventReClick
      ...
      >
        <i class="el-icon-search el-input__icon" slot="prefix" @click="search"></i>
      </VhallInput>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      downloadedEdit(dow_task_ids) {
        ...
        this.$fetch('downloadedEdit', this.$params(params))
          .then(res => {
            // 通知右上角导航，需要更新下载消息
    ...
    currentChangeHandler(current) {
      ...
      getTableList(row) {
        ...
        this.$fetch('downloadedList', this.$params(params))
          .then(res => {
            let dao =
      ...
      async resetDownload(that, { rows }) {
        try {
          ...
          if (result.code === 200 && result.data) {
            ...
            fetch(`${result.data.send_url}`, option)
              .then(res => {
