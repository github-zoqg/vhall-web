  ...
  <div class="privacy-policy">
    ...
    <div class="one">
      ...
      <section>
        ...
        <p class="level-2">
          当您想要试用微吼的产品和服务时，微吼会要求您填写姓名、企业名称、职位、手机号码等基本信息。为了更好的为您提供服务，并给予您相应的试用指导，您同意并认可微吼客服有权通过您预留的联系方式给您打电话、发短信、添加微信好友等方式与您联系。您进一步同意，微吼客服除了向您进行微吼产品服务介绍、使用功能指导之外，还有权向您介绍微吼产品和服务的商务价格、商务策略等。
        </p>
      </section>
      <section>
        ...
        <p class="level-2 font-bold font-italic">
          收集手机号码是也是履行国家关于网络实名制要求的必要信息，如果您拒绝提供手机号码用于注册、登录，微吼可能无法为您提供更完整的产品和服务。
        </p>
      </section>
      <section>
      ...
      <section>
        ...
        <p class="level-2">
          如果您希望开通直播功能，根据国家有关规定，微吼可能需要您完成身份认证。针对个人可能需要您提供联系人姓名、手机号码等有关资料和信息；若为企业则可能需要您提供联系人姓名、手机号码、电子邮箱、QQ号码、办公电话、微信号、公司名称、网址、行业、业务范围等有关资料和信息。收集这些信息是为了满足国家有关实名认证的要求。若您不提供这类信息，可能无法正常使用微吼的相关产品和服务。
        </p>
      </section>
      <section>
    ...
    <div>
      ...
      <section>
        ...
        <el-table :data="staticData" :show-header="false" border :span-method="arraySpanMethod">
        ...
        <p class="level-2">
          微吼通过与上述第三方服务提供者签署的有关协议、制定规范以及合理的产品流程设计，严格要求第三方服务提供者获取您的任何数据均应遵守相关法律法规的规定，采取必要的数据保护措施（例如将该类个人信息做匿名化、去标识化处理），且仅为产品或者服务之目的合理使用您的相关数据，向您提供修改或者删除自己数据的方式，尽最大可能保障您的数据和隐私不受侵害。您在接受或者使用第三方产品或者服务前应充分了解第三方产品或者服务的条款及政策，如果您发现有第三方服务提供者存有相关违法违规行为，可以向微吼投诉，微吼将查实后予以处理。
        </p>
        <p class="level-2">
    ...
    <div>
      ...
      <section>
        ...
        <p class="level-2">
          ...
          的功能。但如果您这么做，则需要在每一次访问微吼的网站时更改用户设置。如需详细了解如何更改浏览器设置，请访问您使用的浏览器的相关设置页面。
        </p>
      </section>
    </div>
    <div>
      ...
      <section>
        <p class="level-2">
          微吼非常重视对未成年人个人信息的保护。根据相关法律法规的规定，如您是未满十八周岁的未成年人，在试用、使用微吼的产品和服务之前，您应当和您的父母或者其他监护人仔细阅读本政策，并在征得您的父母或者其他监护人的同意之后，才能并在父母或者其他监护人指导下使用微吼的产品或者服务。
        </p>
        <p class="level-2">
          根据国家相关法律法规的对保护未成年人个人信息的规定，只有在法律允许、父母或者其他监护人明确同意或者保护未成年人所必要的情况下微吼才会收集、使用、共享或者披露未成年人的个人信息。如果发现在未事先获得可证实的父母或者其他监护人同意的情况下收集了未成年人的个人信息，微吼会设法尽快删除相关信息。如果您认为微吼可能不当地持有未成年人的信息，请您按照本政策所列明的公开联系方式与微吼取得联系。
        </p>
      </section>
    </div>
    <div>
      ...
      <section>
        ...
        <p class="level-2">
          您可以在使用微吼服务的过程中，访问、修改和删除您提供的注册信息和其他个人信息。您访问、修改和删除个人信息的范围和方式将取决于您使用的具体服务。如您发现微吼违反法律、行政法规的规定或者双方的约定收集、使用您的个人信息，您可以要求微吼删除。如您发现微吼收集、存储的您的个人信息有错误的，您也可以要求微吼更正。
        </p>
        <p class="level-2">
      ...
      return {
        staticData: [
          ...
          },
          {
            label: '第三方隐私政策',
            content:
              '<a href="https://cloud.tencent.com/document/product/301/11470" target="_blank">https://cloud.tencent.com/document/product/301/11470</a>'
          },
          {
            label: '',
            content: ''
