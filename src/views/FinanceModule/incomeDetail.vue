    ...
    methods: {
      ...
      getSearchList() {
        ...
        this.$vhall_paas_port({
          k:
            formParams.pay_type == 13
              ? 100765
              : formParams.pay_type == 2
              ? 100766
              : formParams.pay_type == 5
              ? 100767
              : 100764,
          data: {
      ...
      getIncomeDetailList(params) {
        ...
        console.log(obj);
        this.$fetch('liveIncomeDetailList', this.$params(obj))
          .then(res => {
      ...
      // 导出收益详情
      exportAccount() {
        this.$fetch('exportIncomeDetail', this.$params(this.params))
          .then(res => {
            this.$vhall_paas_port({
              k: 100768,
              data: {
