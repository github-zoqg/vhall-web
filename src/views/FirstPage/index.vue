    ...
    <div class="main-center">
      ...
      >
        <el-col :xl="{span: colVal}">
          <router-link
            :to="{path:'/live/edit',query: {refer:1}}"
            class="center-item"
          >
    ...
    <div class="advert-banner">
      ...
      <div class="web-download">
        <div class="ad-web">
          ...
          <img
            src="../../common/images/account/banner1.png"
            alt=""
          />
          <!-- <h1>微吼直播客户端</h1>
          <p>强大文件的直播工具</p> -->
      ...
      <div class="app-download">
        <div class="app-web">
          <div class="img-show"><img
              src="../../common/images/account/banner2.png"
              alt=""
            /></div>
        </div>
        <div class="ad-text">
