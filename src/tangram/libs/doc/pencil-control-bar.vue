...
.doc-ctrl-bar {
  ...
  .slide-bar {
    ...
    &::before {
      ...
      width: 12px;
      height: 12px;
      background-image: url('../../assets/images/publish/new/arrow-top.png');
      background-size: cover;
    }
    &.down {
      &::before {
        background-image: url('../../assets/images/publish/new/arrow-down.png');
      }
    }
  }
  .box {
    ...
    &:hover {
      ...
      & > .arrow {
        background-image: url('../../assets/images/publish/new/doc-ctrl-bar-arrow-hover.png');
      }
      & > .box-item {
    ...
    .box-item {
      ...
      .icon {
        ...
        height: 18px;
        line-height: 18px;
        background-image: url('../../assets/images/publish/doc-ctrl-bar-ygb.png');
        background-size: 18px 18px;
      }
    }
    .ygb {
      .icon {
        background-image: url('../../assets/images/publish/new/doc-ctrl-bar-ygb.png');
      }
    }
    .hb {
      .icon {
        background-image: url('../../assets/images/publish/new/doc-ctrl-bar-hb.png');
      }
    }

    .ys {
      .icon {
        background-image: url('../../assets/images/publish/new/doc-ctrl-bar-ys.png');
      }
    }
    .wz {
      .icon {
        background-image: url('../../assets/images/publish/new/doc-ctrl-bar-wz.png');
      }
    }
    .xpc {
      .icon {
        background-image: url('../../assets/images/publish/new/doc-ctrl-bar-xpc.png');
      }
    }
    .qc {
      .icon {
        background-image: url('../../assets/images/publish/new/doc-ctrl-bar-qc.png');
      }
    }
    ...
    .arrow {
      ...
      width: 6px;
      height: 4px;
      background-image: url('../../assets/images/publish/new/doc-ctrl-bar-arrow.png');
